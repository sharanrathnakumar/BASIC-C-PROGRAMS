...
int my_islower(int);    //Initialising function


int my_islower( int character)  //Function definition
{
    if( character >= 97 && character <= 122 )//checking whether character is in ascii range for alnum
    {
