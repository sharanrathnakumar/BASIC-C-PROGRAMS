...
Description: Negative Fibbonacci
...
int main()
{
    ...
    {
/*        if(term1>0 && -term1<=limit)            //Check whether the term is positive and if it is less than the limit
        {
            printf("%d",term1);
            break;                      //Break the statement
        }
*/      printf("%d ",term1);                    //Priting the first term
        sum=term1-term2;                        //Finding sum of first and negative of second term
